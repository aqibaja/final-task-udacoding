...
List<PopularModel> popularModelFromJson(String str) => List<PopularModel>.from(
    json.decode(str).map((x) => PopularModel.fromJson(x)));

String popularModelToJson(List<PopularModel> data) =>
