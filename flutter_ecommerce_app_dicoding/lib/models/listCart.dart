...
List<ListCartModel> listCartModelFromJson(String str) =>
    List<ListCartModel>.from(
        json.decode(str).map((x) => ListCartModel.fromJson(x)));

String listCartModelToJson(List<ListCartModel> data) =>
